...
AppNexusAdTemplate.AppNexInterstitialConf = {
	...
	_interstitial_xbtn_clsname_css      : "float: right; z-index: 11111; text-align: center; font-weight: bolder; color: #FFF; cursor: pointer; position: fixed; right: 0px; width: 25px; height: 25px; font-size: 23px;",
	_interstitial_xbtn_txt_clsname_css  : "border-radius: 40px; margin: 5px 5px 0 0; border-color: #FFFFFF; border-style: solid; border-width: 5px;",
	_interstitial_img_inner_clsname_css : "zoom: 5; max-width: 100%; max-height: 100%; margin: auto; display: block; top: 50%; left: 50%; transform: translate(-50%, -50%); position: absolute;"
...
AppNexusAdTemplate.AppNexInterstitial = {
	...
	initializeInterstitial: function(aat) {
		...
		ele_img.className = this.conf._interstitial_img_inner_clsname;
		ele_img.style.cssText = this.conf._interstitial_img_inner_clsname_css;
		ele_img.src = this.conf._backimg;
