...
AppNexusAdTemplate.AppNexInterstitialConf = {
	...
	_interstitial_xbtn_clsname_css      : "width: 54px; height: 54px; float: right; z-index: 11111; text-align: center; font-size: 35px; font-weight: bolder; color: #FFF; cursor: pointer; position: fixed; right: 0px;",
