	...
	getImgSize: function() {
		...
		img.onload = function() {
			...
			if (content_img) {
				...
				var y_ratio = (img.height / img.width * 1).toFixed(2);
				var width, height;
...
//				console.log("scrollWidth : " + content_img.scrollWidth);
//				console.log("scrollHeight : " + content_img.scrollHeight);
				console.log("browserWidth : " + aat.conf._browser_width);
				console.log("browserHeight : " + aat.conf._browser_height);
				
				if (x_ratio < y_ratio) { // Image is Portrait
					console.log("### img is portrait");
					width = aat.conf._browser_height * x_ratio + "px";
//					height = aat.conf._browser_width * y_ratio + "px";
					height = "100%";
				} else {
					console.log("### img is landscape");
//					width = "100%";
//					width = aat.conf._browser_height * x_ratio + "px";
//					height = aat.conf._browser_width * y_ratio + "px";
				}
				
//				width = aat.conf._browser_width * x_ratio + "px";
//				height = aat.conf._browser_height * y_ratio + "px";
				
				
				
				content_img.style.width = width;
				content_img.style.height = height;
