...
AppNexusAdTemplate.AppNexInterstitialConf = {
	...
	_interstitial_xbtn_clsname_css       : "float: right; z-index: 11111; text-align: center; font-weight: bolder; color: #FFF; position: fixed; right: 0px; width: 25px; height: 25px; font-size: 23px;",
