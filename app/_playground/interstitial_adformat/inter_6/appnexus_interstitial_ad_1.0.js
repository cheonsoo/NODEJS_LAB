AppNexInterstitialConf = {
	...
	_interstitial_img_clsname_css   : "height: 100%; background-repeat: round; background-size: cover; cursor: pointer; z-index: 111; margin: auto;",
...
aia.AppNexInterstitial = {
	...
	initialize_interstitial: function() {
		...
		ele_div.style.backgroundColor = "rgba(" + this.hex2rgb(this.conf._bgcolor) + ", " + this.conf._bgopacity + ")";
	...
	init: function() {
		...
		this.startTimer(this.conf._timeout-1, display);
	}
}

// window.onload = function() { aia.AppNexInterstitial.init(); }