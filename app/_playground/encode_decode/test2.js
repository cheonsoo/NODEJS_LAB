...
function decode(messagebase64, keyBase64, ivBase64) {

    // const key = Buffer.from(keyBase64, 'base64');
    // const key = [112, 64, 115, 115, 119, 48, 114, 100, 53, 53, 99, 105, 112, 104, 35, 114];
    const iv = [112, 64, 115, 115, 119, 48, 114, 100, 53, 53, 99, 105, 112, 104, 35, 114]
    const key = "p@ssw0rd55ciph#r";
    // const iv = "p@ssw0rd55ciph#r"
