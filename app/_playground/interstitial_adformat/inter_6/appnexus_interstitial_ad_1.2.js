AppNexInterstitialConf = {
	...
	_adImages: ["mobile_portrait.jpg", "mobile_landscape.jpg", "tablet_portrait.png", "tablet_landscape.jpg"], // 1: portrait mobile, 2: landscape mobile, 3: portrait tablet, 4: landscape tablet
	...
	getImgSize: function() {
		...
		img.onload = function() {
			...
			if (that.conf._orientation == "portrait") {
				...
				var img = that.conf._userAgent[2] == "mobile" ? that.conf._adImages[0] : that.conf._adImages[2];
				content_img.style.backgroundImage = "url(" + img + ")";
			} else {
